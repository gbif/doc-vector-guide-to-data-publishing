...
With this guide, we hope to encourage the publication of vector data under the FAIR Principles of _findability_, _accessibility_, _interoperability_ and _reproducibility_ (https://www.nature.com/articles/sdata201618[Wilkinson et al. 2016^]), not only to contribute to a better understanding of disease biology, ecology, and transmission, but also to inform epidemic preparedness and response as well as VBD control and elimination strategies.
