...
We aim to provide guidance on publishing data on <<vector,vectors>>, <<host,hosts>> and pathogens that cause human and animal diseases through GBIF—the Global Biodiversity Information Facility.
